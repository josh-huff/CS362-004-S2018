...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    //TODO Refactored into function and introduced subtle bug.
    case adventurer:
    ...
    case council_room:
      ...
      return card_council_room(state, currentPlayer, handPos);
    ...
    //TODO Refactored into function but DID NOT introduce subtle bug.			
    case remodel:

      return card_remodel(state, currentPlayer, choice1, choice2, handPos);
