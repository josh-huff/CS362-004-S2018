...
int playAdventurer(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[MAX_HAND], int handPos) {
      int z = 0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return (playAdventurer(drawntreasure, state, currentPlayer, cardDrawn, temphand, handPos));
...
//TODO Huff's custom assert method, to collect coverage and bug information without ending program execution
...
// "Quiet" random variant -- difference counter maintains error counts instead
int r_asserttrue(int condition1, int condition2){
